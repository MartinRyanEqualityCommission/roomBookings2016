...
Partial Class _Default
    ...
    Private Sub popData()
        ...
        While rdr.Read()
            ...
            If Not IsDBNull(rdr("roomID")) Then
                If rdr("roomID") > 0 Then
                    ...
                    If CInt((rdr("roomendSlot"))) = 11 Or CInt((rdr("roomendSlot"))) = 22 Or CInt((rdr("roomendSlot"))) = 33 Or CInt((rdr("roomendSlot"))) = 44 Or CInt((rdr("roomendSlot"))) = 55 Or CInt((rdr("roomendSlot"))) = 66 Or CInt((rdr("roomendSlot"))) = 77 Then
                    ...
                    arrRoomInfo1(curSlotID) = arrRoomInfo1(curSlotID) + "<strong><a title=""" + rdr("roomBookingTitle") + """ onclick=""javascript:window.open('displayBooking.aspx?bookID=" + CInt(rdr("roomBookingID")).ToString + "','','scrollbars=1,width=500,height=400,resizable=yes,location=no');return false;"" href=""#"">" + arrTimeDesc(CInt(rdr("roomStartSlot"))) + " - " + arrTimeDesc(vEndSlot) + "</a></strong><br>" + rdr("roomSRDetail").ToString + " (" + varNoAttending.ToString + " Attendees)" + varComments
                End If
            End If
        End While
        ...
        For i = 1 To 35
            ...
            End If
        Next
        arrRow(1) = "<tr style=""background-color: #ECFBEA;""><th style=""text-align: center; background-color: #DDEBF5; border-top: 1px solid #003399; border-left: 1px solid #003399; border-bottom: 1px solid #003399; border-right: 1px solid #003399; color: #003399; padding: 5px; min-height: 60px;"">Board Room</th><td style=""background-color: #E3F9E3;"" width=""16%"">" + arrCell(1).ToString + "</td><td style=""padding: 5px;"" width=""16%"">" + arrCell(8).ToString + "</td><td style=""background-color: #E3F9E3; padding: 5px;"" width=""16%"">" + arrCell(15).ToString + "</td><td style=""padding: 5px;"" width=""16%"">" + arrCell(22).ToString + "</td><td style=""background-color: #E3F9E3; padding: 5px;"" width=""16%"">" + arrCell(29).ToString + "</td></tr>"
        arrRow(2) = "<tr style=""background-color: #E0F8E0;""><th style=""text-align: center; background-color: #DDEBF5; border-top: 1px solid #003399; border-left: 1px solid #003399; border-bottom: 1px solid #003399; border-right: 1px solid #003399; color: #003399; padding: 5px; min-height: 60px;"">Ante Room</th><td style=""background-color: #DBF7DB; padding: 5px;"">" + arrCell(2).ToString + "</td><td>" + arrCell(9).ToString + "</td><td style=""background-color: #DBF7DB; padding: 5px;"">" + arrCell(16).ToString + "</td><td style=""padding: 5px;"">" + arrCell(23).ToString + "</td><td style=""background-color: #DBF7DB; padding: 5px;"">" + arrCell(30).ToString + "</td></tr>"
        arrRow(3) = "<tr style=""display: none;""><th>Training Room</th><td style=""border-bottom: 1px solid #808080;"">" + arrCell(3).ToString + "</td><td style=""border-bottom: 1px solid #808080;"">" + arrCell(10).ToString + "</td><td style=""border-bottom: 1px solid #808080;"">" + arrCell(17).ToString + "</td><td style=""border-bottom: 1px solid #808080;"">" + arrCell(24).ToString + "</td><td style=""border-bottom: 1px solid #808080;"">" + arrCell(31).ToString + "</td></tr>"
        arrRow(4) = "<tr style=""background-color: #ECFBEA;""><th style=""text-align: center; background-color: #DDEBF5; border-top: 1px solid #003399; border-left: 1px solid #003399; border-bottom: 1px solid #003399; border-right: 1px solid #003399; color: #003399; padding: 5px; min-height: 60px;"">Meeting Room 3</th><td style=""background-color: #E3F9E3;"">" + arrCell(4).ToString + "</td><td style=""padding: 5px"">" + arrCell(11).ToString + "</td><td style=""background-color: #E3F9E3;"">" + arrCell(18).ToString + "</td><td style=""padding: 5px;"">" + arrCell(25).ToString + "</td><td style=""background-color: #E3F9E3;"">" + arrCell(32).ToString + "</td></tr>"
        arrRow(5) = "<tr style=""background-color: #E0F8E0;""><th style=""text-align: center; background-color: #DDEBF5; border-top: 1px solid #003399; border-left: 1px solid #003399; border-bottom: 1px solid #003399; border-right: 1px solid #003399; color: #003399; padding: 5px; min-height: 60px;"">Meeting Room 1</th><td style=""background-color: #DBF7DB; padding: 5px;"">" + arrCell(5).ToString + "</td><td style=""padding: 5px;"">" + arrCell(12).ToString + "</td><td style=""background-color: #DBF7DB; padding: 5px;"">" + arrCell(19).ToString + "</td><td style=""padding: 5px;"">" + arrCell(26).ToString + "</td><td style=""background-color: #DBF7DB; padding: 5px;"">" + arrCell(33).ToString + "</td></tr>"
        arrRow(6) = "<tr style=""background-color: #ECFBEA;""><th style=""text-align: center; background-color: #DDEBF5; border-top: 1px solid #003399; border-left: 1px solid #003399; border-bottom: 1px solid #003399; border-right: 1px solid #003399; color: #003399; padding: 5px; min-height: 60px;"">Meeting Room 2 </th><td style=""background-color: #E3F9E3;"">" + arrCell(6).ToString + "</td><td style=""padding: 5px;"">" + arrCell(13).ToString + "</td><td style=""background-color: #E3F9E3;"">" + arrCell(20).ToString + "</td><td style=""padding: 5px"">" + arrCell(27).ToString + "</td><td style=""background-color: #E3F9E3;"">" + arrCell(34).ToString + "</td></tr>"
        arrRow(7) = "<tr style=""background-color: #E0F8E0;""><th style=""text-align: center; background-color: #DDEBF5; border-top: 1px solid #003399; border-left: 1px solid #003399; border-bottom: 1px solid #003399; border-right: 1px solid #003399; color: #003399; padding: 5px; min-height: 60px;"">Glass Room</th><td style=""background-color: #DBF7DB;"">" + arrCell(7).ToString + "</td><td style=""padding: 5px;"">" + arrCell(14).ToString + "</td><td style=""background-color: #DBF7DB; padding: 5px;"">" + arrCell(21).ToString + "</td><td style=""padding: 5px;"">" + arrCell(28).ToString + "</td><td style=""background-color: #DBF7DB;"">" + arrCell(35).ToString + "</td></tr>"
