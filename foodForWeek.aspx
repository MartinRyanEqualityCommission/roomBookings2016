<%@ Page MaintainScrollPositionOnPostback="true" Language="VB" MasterPageFile="~/roomLook.master" AutoEventWireup="true" CodeFile="foodForWeek.aspx.vb" Inherits="_Default" %>
...
<div id="weekFoodDisplay" runat="server">
